      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-0 bg-black has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
...
// Memoize the SidebarContent component to prevent unnecessary re-renders
...
// Memoize the SidebarGroup component to prevent unnecessary re-renders
